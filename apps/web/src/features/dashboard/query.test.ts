...
it("derives paid months from the supplied full coherent history independently of analysis success", async () => {
  ...
  adapter.listConfirmedRecurringSuggestions = async () => [{ id: ownerUserId, creationSource: "detected", state: "confirmed", eligible: false, label: "Cloud", amountCents: 1000, dayOfMonth: 5, nextDate: "2026-10-05", lastPaymentDate: "2026-09-05", sourcePublication: "2026-08-01T00:00:00Z", linkedExpenseId: recurringId, accountId: ownerUserId, currency: "EUR", normalizedLabel: "cloud", evidence: [], possibleDuplicates: [] }];
