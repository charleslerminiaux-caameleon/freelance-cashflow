...
Cette extension utilise les migrations `202609120001_history_recurring_decisions.sql` et `202609120002_automatic_qonto_admission.sql`, **explicitement autorisées et appliquées sur cette installation Supabase hébergée le 14 septembre 2026**, après leur revue et les tests isolés. Le contrôle final confirme leur application et la disponibilité des colonnes attendues. Pour une autre installation, une revue SQL et un accord explicite restent nécessaires.
