...
La première synchronisation reste manuelle. Après une publication réussie, l’application vérifie son âge à l’ouverture, au retour au premier plan et toutes les cinq minutes quand l’onglet est visible. À partir de 24 heures, le serveur peut lancer une synchronisation. Une décision atomique partage le verrou du lancement manuel et empêche deux onglets de publier deux imports successifs. Le serveur espace les tentatives automatiques d’au moins quinze minutes, notamment après un échec ; les vérifications continuent pendant ce délai sans appel Qonto supplémentaire. Une application fermée ne se synchronise pas : aucun worker n’est installé.

Le badge Qonto du solde distingue fraîcheur inférieure à 24 heures, vérification, synchronisation en cours, données anciennes et échec. Au clavier, au survol ou au toucher, il donne la date et l’heure françaises dans le fuseau du propriétaire. Un échec connu retire l’état vert et donne accès à Intégrations. Le dernier solde valide reste disponible ; une analyse des récurrences échouée ne retire pas la publication bancaire. Une actualisation de la vue conserve les formulaires en cours et les paramètres du scénario.
