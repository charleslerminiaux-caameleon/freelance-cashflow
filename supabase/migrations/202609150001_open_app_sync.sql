-- Refresh while the app is visible. Successful publications permit the next
-- five-minute refresh; only unsuccessful attempts retain the longer backoff.
create or replace function public.acquire_automatic_banking_sync(p_owner_user_id uuid, p_run_id uuid)
